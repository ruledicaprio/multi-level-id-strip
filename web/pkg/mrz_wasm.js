 ...
 * @returns {string}
 */
export function parse_mrz_text(text) {
    let deferred2_0;
    let deferred2_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mrz_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
